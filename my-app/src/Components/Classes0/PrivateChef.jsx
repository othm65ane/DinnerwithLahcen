...
import Popup from '../Popuup/Popup';7
        ...
        <div className="max-w-screen-md w-full mx-auto ">
          ...
          <form ref={form} onSubmit={sendEmail} className="space-y-8">
            ...
            <motion.div
              ...
              whileInView={{y: 0, opacity: 1}}
              transition={{duration: 1}}>
              <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your Location</label>
              <input 
                type="text" 
                id="subject" 
                name='user_location' 
                className="shadow-sm outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" 
                placeholder="Entre Your Location" 
                required 
              />
            </motion.div>
...
>
  ...
  <a
      ...
      class="inline-block cursor-pointer w-full font-semibold rounded-lg bg-[#97BE5A] px-5 py-3 text-center text-sm font-semibold text-white sm:w-auto"
    >
     Go Home
    </a>
    <a
      ...
      class="inline-block lg:ml-2 mt-4 w-full   cursor-pointer font-semibold bg-[#97BE5A] rounded-lg px-5 py-3 text-center text-sm font-semibold text-white sm:w-auto"
    >
     Close
    </a>
</div>
